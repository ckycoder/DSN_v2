...
batch_size = {'train': 512,
              'val': 100}
cate_num = 5
save_model_path = '../model_48/slc_spexy_cae_48_3_'
...
dataset = {x : SLC_spe_xy(txt_file=txt_file[x], spe_dir='../data/spe_data_48/',sublook=48,
    ...
    for sample in dataloader['train']:
        ...
        if i % 10 == 0:
            ...
            if i % 100 == 0:
                ...
                # if i % 1000 == 0:
                #     torch.save(net.state_dict(), save_model_path + 'iter' + str(i+243000) + '.pth')
        i += 1
