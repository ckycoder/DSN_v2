...
save_path = '../data/spexy_data_32/'


net = network.SLC_spexy_CAE()
net.load_state_dict(torch.load('../model/slc_spexy_cae_3_iter34000.pth'))

dataset = SLC_spe_4D(txt_file=txt_file, spe_dir='../data/spe_data_32/', spe_transform=data_transforms)
