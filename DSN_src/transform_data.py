...
class Normalize_img(object):
    ...
    # 7.565887666590074,1.2510649766641504
class Normalize_all_spe(object):
    def __init__(self, mean=7.565887666590074, std=1.2510649766641504):
        self.mean = mean
        self.std = std

    def __call__(self, all_spe):
        all_spe = (all_spe- self.mean) / self.std
